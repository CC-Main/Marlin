...
#define STRING_CONFIG_H_AUTHOR "(CC Main , Biqu B1 Custom)" // Who made the changes. //CCM
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_4_TURBO //CCM
#endif
...
#define CUSTOM_MACHINE_NAME "BIQU B1 Custom" //CCM
...
#define X_DRIVER_TYPE  TMC2209 //CCM
#define Y_DRIVER_TYPE  TMC2209 //CCM
#define Z_DRIVER_TYPE  TMC2208  // TMC2225 //CCM
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2208  // TMC 2225 //CCM
...
#define E0_DRIVER_TYPE TMC2209 //CCM
...
#define HEATER_0_MAXTEMP 270 //CCM
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash) //CCM
  #define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash) //CCM
#endif
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //CCM
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //CCM
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 4 //CCM
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 913.73 } //CCM
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } //CCM
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 5000 } //CCM
 ...
 */
#define DEFAULT_ACCELERATION          500    // X, Y, Z and E acceleration for printing moves //CCM
#define DEFAULT_RETRACT_ACCELERATION  500    // E acceleration for retracts //CCM
#define DEFAULT_TRAVEL_ACCELERATION   500    // X, Y, Z acceleration for travel (non printing) moves //CCM
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //CCM

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING //CCM
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10, -30, -2.78 } //CCM
...
#define INVERT_X_DIR true //CCM
#define INVERT_Y_DIR false //CCM
...
#define X_BED_SIZE 235 //CCM
#define Y_BED_SIZE 235 //CCM

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -5 //CCM
#define Y_MIN_POS -3 //CCM
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 270 //CCM
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 7 //CCM

  #ifdef FILAMENT_RUNOUT_DISTANCE_MM
    // Enable this option to use an encoder disc that toggles the runout pin
    // as the filament moves. (Be sure to set FILAMENT_RUNOUT_DISTANCE_MM
    // large enough to avoid false positives.)
    #define FILAMENT_MOTION_SENSOR //CCM
  #endif
#endif
...
#define AUTO_BED_LEVELING_BILINEAR //CCM
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION Z_MIN_PROBE_REPEATABILITY_TEST 
  ...
  #define GRID_MAX_POINTS_X 6 //CCM
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  // Probe along the Y axis, advancing X after each column
  #define PROBE_Y_FIRST //CCM
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 //CCM
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT  // Init EEPROM automatically on any errors. //CCM
...
#define PREHEAT_1_TEMP_HOTEND 200 //CCM
#define PREHEAT_1_TEMP_BED     60 //CCM
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG" //CCM
#define PREHEAT_2_TEMP_HOTEND 230 //CCM
#define PREHEAT_2_TEMP_BED    70 //CCM
 ...
 */
#define NOZZLE_PARK_FEATURE //CCM

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MIN_POS + 10), 20 } //CCM
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //CCM
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //CCM
...
#define NEOPIXEL_LED //CCM
#if ENABLED(NEOPIXEL_LED)
  #define NEOPIXEL_TYPE          NEO_GRB // NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc. //CCM
                                          // See https://github.com/adafruit/Adafruit_NeoPixel/blob/master/Adafruit_NeoPixel.h
  //#define NEOPIXEL_PIN                4 // LED driving pin
  //#define NEOPIXEL2_TYPE  NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN               5
  #define NEOPIXEL_PIXELS              2 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.) //CCM
  //#define NEOPIXEL_IS_SEQUENTIAL          // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once. //CCM
  #define NEOPIXEL_BRIGHTNESS         127 // Initial brightness (0-255)
  #define NEOPIXEL_STARTUP_TEST         // Cycle through colors at startup //CCM
