 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        180 // Seconds //CCM
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                180 // Seconds //CCM
 ...
 */
#define HOTEND_IDLE_TIMEOUT //CCM
#if ENABLED(HOTEND_IDLE_TIMEOUT)
  #define HOTEND_IDLE_TIMEOUT_SEC (10*60)    // (seconds) Time without extruder movement to trigger protection //CCM
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first //CCM
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true //CCM
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //CCM
...
#define DISABLE_INACTIVE_Z false  // Set 'false' if the nozzle could fall onto your printed part! //CCM
//#define DISABLE_INACTIVE_I true //CCM
//#define DISABLE_INACTIVE_J true //CCM
//#define DISABLE_INACTIVE_K true //CCM
//#define DISABLE_INACTIVE_U true //CCM
//#define DISABLE_INACTIVE_V true //CCM
//#define DISABLE_INACTIVE_W true //CCM
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING //CCM
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //CCM
    ...
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } //CCM
  #endif
#endif
  ...
  #define STATUS_MESSAGE_SCROLLING //CCM
...
#define SET_PROGRESS_MANUALLY //CCM
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           // Display estimated time to completion (prefix 'R') //CCM
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true  // Pre-allocate a static array for faster pre-sorting. //CCM
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true  // Keep sorted items in RAM longer for speedy performance. Most expensive option. //CCM
    #define SDSORT_DYNAMIC_RAM true  // Use dynamic allocation (within SD menus). Least expensive option. Set SDSORT_LIMIT before use! //CCM
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' //CCM
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu //CCM
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' //CCM
   ...
   */
  //#define USB_FLASH_DRIVE_SUPPORT //CCM
   ...
   */
  #define SDCARD_CONNECTION ONBOARD //CCM
 ...
 */
  ...
  #define STATUS_HEAT_PERCENT       // Show heating in a progress bar //CCM
...
#define BABYSTEPPING //CCM
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  5       // (steps or mm) Steps or millimeter distance for each Z babystep //CCM
  ...
  //#define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle. //CCM
    #if ENABLED(MOVE_Z_WHEN_IDLE)
      #define MOVE_Z_IDLE_MULTIPLICATOR 2   // Multiply 1mm by this factor for the move step size. //CCM
    #endif
  #endif
 ...
 */
#define LIN_ADVANCE //CCM
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.0 }    // (mm) Compression length per 1mm/s extruder speed, per extruder //CCM
  #else
    #define ADVANCE_K 0.0        // (mm) Compression length applying to all extruders //CCM
  #endif
 ...
 */
  ...
  #define PROBING_MARGIN_BACK 60 //CCM
#endif
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32 //CCM
#else
...
#define SERIAL_FLOAT_PRECISION 4 //CCM
 ...
 */
#define ADVANCED_PAUSE_FEATURE //CCM
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         30  // (mm/s) Initial retract feedrate. //CCM
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     30  // (mm/s) Unload filament feedrate. This can be pretty fast. //CCM
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      450 // (mm) The length of filament for a complete unload. //CCM
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   6  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     25  // (mm) Slow length, to allow time to insert material. //CCM
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   25 // (mm/s) Load filament feedrate. This can be pretty fast. //CCM
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     350  // (mm) Load length of filament, from extruder gear to nozzle. //CCM
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        5  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate. //CCM
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. //CCM
  #define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change //CCM

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. //CCM
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) //CCM
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT //CCM
#endif
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations //CCM
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others) //CCM
 ...
 */
#define HOST_ACTION_COMMANDS //CCM
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback //CCM
