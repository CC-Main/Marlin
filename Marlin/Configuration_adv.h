...
#define USE_CONTROLLER_FAN
  ...
  //#define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings //CCM
...
#define HOMING_BUMP_MM      { 5, 5, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump //CCM
...
// @section bltouch
  ...
  //#define BLTOUCH_FORCE_SW_MODE //CCM
...
//
#define ASSISTED_TRAMMING //CCM
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  50, 50 }, { 310,  50 }, { 310, 310 }, { 50, 310 } } //CCM
  ...
  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu //CCM
   ...
   */
  #define TRAMMING_SCREW_THREAD 30 //CCM
 ...
 */
#define INPUT_SHAPING_X //CCM
#define INPUT_SHAPING_Y //CCM
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. //CCM
#endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define UTF_FILENAME_SUPPORT //CCM

  #define LONG_FILENAME_HOST_SUPPORT      // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  #define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol //CCM
 ...
 */
  ...
  //#define STATUS_CHAMBER_ANIM         // Use a second bitmap to indicate chamber heating //CCM
...
#define BABYSTEPPING
  ...
  //#define BABYSTEP_WITHOUT_HOMING //CCM
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      60  // (mm) The length of filament for a complete unload. //CCM
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   100  // (mm) Load length of filament, from extruder gear to nozzle. //CCM
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS //CCM
  ...
  #define Z_HYBRID_THRESHOLD       3 //CCM
   ...
   */
  #define SQUARE_WAVE_STEPPING //CCM

  /**
   * Enable M122 debugging command for TMC stepper drivers.
   * M122 S0/1 will enable continuous reporting.
   */
  //#define TMC_DEBUG //CCM
...
#define HOST_ACTION_COMMANDS
  ...
  #define HOST_PROMPT_SUPPORT             // Initiate host prompts to get user feedback
    ...
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications //CCM
  #endif
